...
from fooof_PLA.plts.fg import plot_fg
from fooof_PLA.core.items import OBJ_DESC
from fooof_PLA.core.info import get_indices
from fooof_PLA.core.utils import check_inds
from fooof_PLA.core.errors import NoModelError
from fooof_PLA.core.reports import save_report_fg
from fooof_PLA.core.strings import gen_results_fg_str
from fooof_PLA.core.io import save_fg, load_jsonlines
from fooof_PLA.core.modutils import copy_doc_func_to_method, safe_import
...
class FOOOFGroup(FOOOF):
    ...
    def get_fooof(self, ind, regenerate=True):
        ...
        fm = FOOOF(*self.get_settings(), verbose=self.verbose, mod=self.mod)
